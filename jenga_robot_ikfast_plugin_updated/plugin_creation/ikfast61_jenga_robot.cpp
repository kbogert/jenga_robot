...
///
/// ikfast version 0x10000049 generated on 2018-07-12 17:49:25.593926
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
eetrans[2]=((-0.20438)+(((2.0e-7)*x19))+((x10*((((x0*x13))+(((0.0715)*x18))))))+(((0.14203)*x18))+((x9*(((((0.0715)*x21))+(((-1.0)*x13*x3))))))+(((0.14203)*x22))+(((0.04825)*x1))+(((-0.14203)*x2))+(((-2.0e-7)*x21)));
}
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - jenga_robot (a5f37373dc49d51a31981555a1b6951c)>"; }
